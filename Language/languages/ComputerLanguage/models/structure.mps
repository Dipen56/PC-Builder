...
<model ref="r:bfb2846b-062d-4103-8fed-92993a76048d(ComputerLanguage.structure)">
  ...
  <node concept="1TIwiD" id="6KMGxbs_OyH">
    ...
    <node concept="1TJgyi" id="2e$jl8SJJvo" role="1TKVEl">
      <property role="IQ2nx" value="2568262703042721752" />
      <property role="TrG5h" value="min_gpu_gflops" />
      <ref role="AX2Wp" to="tpck:fKAQMTA" resolve="integer" />
    </node>
    <node concept="1TJgyi" id="2e$jl8SJJvQ" role="1TKVEl">
      <property role="IQ2nx" value="2568262703042721782" />
      <property role="TrG5h" value="min_cpu_performance" />
      <ref role="AX2Wp" to="tpck:fKAQMTA" resolve="integer" />
    </node>
    <node concept="1TJgyi" id="2e$jl8SJJvU" role="1TKVEl">
      <property role="IQ2nx" value="2568262703042721786" />
      <property role="TrG5h" value="min_HDD_space" />
      <ref role="AX2Wp" to="tpck:fKAQMTA" resolve="integer" />
    </node>
    <node concept="1TJgyi" id="2e$jl8SJJvZ" role="1TKVEl">
      <property role="IQ2nx" value="2568262703042721791" />
      <property role="TrG5h" value="min_RAM" />
      <ref role="AX2Wp" to="tpck:fKAQMTA" resolve="integer" />
    </node>
  </node>
